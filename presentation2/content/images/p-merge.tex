...
\begin{tikzpicture}
    ...
    \node (Ax)     [subarray, right=0cm of Al] {$x$};
    ...
    \node (Tx)     [subarray, right=0cm of Tll] {$x$};
    ...
    \node (p1) at (Tll.north west) [yshift=1em] {$p_1$};
    \node (q1) at (Tx.north)       [yshift=1em] {$q_1$};
    \node (r1) at (Tlh.north east) [yshift=1em] {$r_1$};
    \node (p2) at (Thl.north west) [yshift=1em] {$p_2$};
    \node (q2) at (Thl.north east) [yshift=1em] {$q_2$};
    \node (r2) at (Thh.north east) [yshift=1em] {$r_2$};
